...
public class DownloaderTaskFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		ArrayList<Integer> arrList = args.getIntegerArrayList("friends");
		Integer[] friendsArray = new Integer[arrList.size()];
		arrList.toArray(friendsArray);

		
		// TODO: Start the DownloaderTask
		dt.execute(friendsArray);
